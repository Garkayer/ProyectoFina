...
public class PostPresenter implements PostContract.Presenter {
    ...
    public void validatePostInfo(EditText PostDescription, Bitmap BitMapPostImage) {
        ...
        if (BitMapPostImage == null){
            Toast.makeText(mContext, "Porfavor selecciona la imagen", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(description)){
            Toast.makeText(mContext, "Di algo sobre tu imagen", Toast.LENGTH_SHORT).show();
        }
        else{

            mView.showLoadingBar("Actualizando tu post", "Porfavor espera...");
